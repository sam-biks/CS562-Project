...
EXPORT_DLL int RGBE_ReadHeader_FNAME(const char* fname, int *width, int *height, char *errbuf)
{
    FILE* fp = fopen(fname, "rb");
    return RGBE_ReadHeader(fp, width, height, NULL, errbuf);
}
                                   ...
                                   int num_scanlines, char *errbuf)
{
    FILE* fp = fopen(fname, "rb");
    int width, height;
    RGBE_ReadHeader(fp, &width, &height, NULL, errbuf);
    return RGBE_ReadPixels_RLE(fp, data, scanline_width, num_scanlines, errbuf);
}
